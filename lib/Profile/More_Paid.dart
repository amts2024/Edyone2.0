...
class MorePaid extends StatefulWidget {
  @override
  _MorePaidState createState() => _MorePaidState();
}

class _MorePaidState extends State<MorePaid> {
                      ...
                      Column(
                        children: [
                          ...
                          buildContainer(
                            title: 'Schedule',
                            icon: 'icon/biomatric.png',
                            isSelected: selectedContainer == 'Schedule',
                            onTap: () => selectContainer('Schedule'),
                          ),
                          const SizedBox(height: 10),
                          buildContainer(
                            title: 'Instructors',
                            icon: 'icon/instruct.png',
                            isSelected: selectedContainer == 'Instructors',
                            onTap: () => selectContainer('Instructors'),
                          ),
                          const SizedBox(height: 10),
                          buildContainer(
                            title: 'About Us',
                            icon: 'icon/about1.png',
                            isSelected: selectedContainer == 'About Us',
                            onTap: () => selectContainer('About Us'),
                          ),
                          const SizedBox(height: 10),
                          buildContainer(
                            title: 'Features',
                          ...
                          buildContainer(
                            title: 'FAQs',
                            icon: 'icon/faq1.png',
                            isSelected: selectedContainer == 'FAQs',
                            onTap: () => selectContainer('FAQs'),
                          ),
                          const SizedBox(height: 10),
                          buildContainer(
                            title: 'Privacy Policy',
                            icon: 'icon/privacy.png',
                            isSelected: selectedContainer == 'Privacy Policy',
                            onTap: () => selectContainer('Privacy Policy'),
                          ),
                          const SizedBox(height: 10),
                          buildContainer(
                            title: 'Terms and Conditions',
                            icon: 'icon/tc.png',
                            isSelected: selectedContainer == 'Terms and Conditions',
                            onTap: () => selectContainer('Terms and Conditions'),
                          ),
                          const SizedBox(height: 10),
