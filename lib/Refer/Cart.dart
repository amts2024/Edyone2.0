    ...
    return Scaffold(
      body: Stack(
        children: [
            ...
            child: Column(
              children: [
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      height: 19.2 / 16, // Equivalent to 19.2px line height
                                      ...
                                      Row(
                                        children: [
                                          Icon(
                                            ...
                                            color: Color(0xFFE4626F), // Same color as the background of the text
                                          ),
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(
                                              ...
                                              fontWeight: FontWeight.w400,
                                              height: 12 / 10, // Equivalent to 12px line height
                                              color: Color(0xFFE4626F), // Text color
                ...
                Container(
                  ...
                  margin: const EdgeInsets.only(top: 10), // Adjust this as needed to position the container
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: Colors.black.withOpacity(0.15), // Shadow color with opacity (0x26 is equivalent to 15% opacity)
                        spreadRadius: 0,
                        blurRadius: 20, // Blur radius for shadow
                        offset: const Offset(0, 4), // Shadow position
                      ),
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.only(), // Adjust the top padding as needed
                              child: Center(
                                child: Container(
                                  width: 356 - 20, // Total width (388) minus the left and right padding (10 + 10)
                                  height: 40, // Specified height
                                  padding: const EdgeInsets.fromLTRB(16, 11, 10, 11), // Internal padding
                                  decoration: BoxDecoration(
                                    borderRadius: const BorderRadius.only(
                                      topLeft: Radius.circular(4), // Specified border radius for top-left
                                    ),
                                    border: Border.all(color: Color(0xFFE4E4E4), width: 1), // Border color and width
                                  ),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween, // Space between the two text widgets
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          fontSize: 14,
                                          fontWeight: FontWeight.w400,
                                          height: 16.8 / 14, // Equivalent to 16.8px line height
                                          color: Color(0xFF9A9A9A), // Text color
                                        ),
                                      ),
                                      Text(
                                        'Apply',
                                        style: TextStyle(
                                          ...
                                          height: 16.8 / 14, // Equivalent to 16.8px line height
                                          color: Color(0xFFA505D5), // Text color
                                        ),
                                      ),
                                    ],
                                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin: const EdgeInsets.only(top: 20), // Adjust margin as needed
                          padding: const EdgeInsets.symmetric(), // Padding for internal spacing
                          decoration: BoxDecoration(
                            color: Colors.transparent, // Background color set to transparent if opacity is 0
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
          ...
          Align(
            alignment: Alignment.bottomCenter, // Aligns the container to the bottom center
            child: Container(
              width: 428, // Fixed width
              height: 64, // Fixed height
              padding: const EdgeInsets.fromLTRB(16, 12, 16, 11), // Padding as specified
              decoration: BoxDecoration(
                color: Colors.white, // Background color
                boxShadow: [
                  BoxShadow(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // Space between child widgets
                children: [
                  Row(
                    children: [
                      Container(
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.symmetric(vertical: 12, horizontal: 2), // Padding
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xFFA10048), Color(0xFF2300FF)], // Gradient background
                      ...
                      borderRadius: BorderRadius.only(
                        ...
                        bottomLeft: Radius.circular(6), // Rounded top-left corner
                        bottomRight: Radius.circular(6), // Rounded top-left corner
                      ),
                    ),
                    child: Center(
                      child: Text(
